        ...
        <div id="aboutMe" className="aboutme">
          ...
          <div className="columns">
            ...
            <div className="aboutmecolumn">
              <p>
                As a recent graduate of the web development Bootcamp from Lighthouse Labs, I am eager to start my career in web development. I am bringing my work ethic and creative problem solving skills that I developed during my seven year career as a professional figure skater and from my Bachelors degree in Fine Art. Now, I'm creating new web apps just to experiment and to test the limits of what I can do with Javascript. I've started to teach myself Swift as well so that I can expand my knowledge and further my own app development capabilities.
            </p>
